...
## 元寶系統接口清單
 ...
  - getBetRecords/{productId}-<a href="#getBetRecords/{language}/{productId}(POST)">取得所有注單紀錄(POST)</a>
  - getBetRecords/{productId}/{account}-<a href="#getBetRecords/{language}/{productId}/{account}(POST)">取得單一會員注單紀錄(POST)</a>


## 參數說明(<a href="#parametersTable">參數說明</a>) 

### <p id="getBetRecords/{language}/{productId}(POST)">getBetRecords/{language}/{productId}-取得所有注單紀錄(POST)</p>
#### Reuqest

- Method: **POST**
- URL: ```/getBetRecords/{language}/{productId}```
...
### <p id="getBetRecords/{language}/{productId}/{account}(POST)">getBetRecords/{language}/{productId}/{account}(POST)-取得單一會員注單紀錄(POST)</p>
#### Reuqest

- Method: **POST**
- URL: ```/getBetRecords/{language}/{productId}/{account}```
- Headers： Content-Type:application/json
- Body:
```
{
