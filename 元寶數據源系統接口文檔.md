...
## 元寶系統接口清單
 ...
  - bet-record/{productId}-<a href="#bet-record/{language}/{productId}(POST)">取得所有注單紀錄(POST)</a>
  - bet-record/{productId}/{account}-<a href="#bet-record/{language}/{productId}/{account}(POST)">取得單一會員注單紀錄(POST)</a>


## 參數說明(<a href="#parametersTable">參數說明</a>) 

### <p id="bet-record/{language}/{productId}(POST)">bet-record/{productId}-取得所有注單紀錄(POST)</p>
#### Reuqest

- Method: **POST**
- URL: ```/bet-record/{language}/{productId}```
...
### <p id="bet-record/{language}/{productId}/{account}(POST)">bet-record/{language}/{productId}/{account}(POST)-取得單一會員注單紀錄(POST)</p>
#### Reuqest

- Method: **POST**
- URL: ```/bet-record/{language}/{productId}/{account}```
- Headers： Content-Type:application/json
- Body:
```
{
