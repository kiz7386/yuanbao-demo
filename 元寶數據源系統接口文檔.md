...
## 元寶系統接口清單
 ...
  - bet-records/{productId}-<a href="#bet-records/{language}/{productId}(POST)">取得所有注單紀錄(POST)</a>
  - bet-records/{productId}/{account}-<a href="#bet-records/{language}/{productId}/{account}(POST)">取得單一會員注單紀錄(POST)</a>


## 參數說明(<a href="#parametersTable">參數說明</a>) 

### <p id="bet-records/{language}/{productId}(POST)">bet-records/{language}/{productId}-取得所有注單紀錄(POST)</p>
#### Reuqest

- Method: **POST**
- URL: ```/bet-records/{language}/{productId}```
...
### <p id="bet-records/{language}/{productId}/{account}(POST)">bet-records/{language}/{productId}/{account}(POST)-取得單一會員注單紀錄(POST)</p>
#### Reuqest

- Method: **POST**
- URL: ```/bet-records/{language}/{productId}/{account}```
- Headers： Content-Type:application/json
- Body:
```
{
